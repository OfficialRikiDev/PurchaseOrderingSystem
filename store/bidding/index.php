...
<body class="overflow-hidden">
    <div class="flex bg-gray-700 h-screen" x-data="{ isSidebarExpanded: false }">
        ...
        <div class="flex flex-col w-full h-[vh]">
            ...
            ?>
            <main class="flex flex-row gap-x-2 h-full gap-y-3 w-full p-4 mx-auto overflow-hidden">
                <div class="flex flex-col gap-2 w-1/3 bg-slate-800 rounded p-6 justify-between">
                    <div class="flex flex-col">
                        <div class="flex justify-between">
                            <span class="font-bold text-2xl">
                                Title
                            </span>
                            <span class="text-xs place-self-center">Ending in 12:00:00</span>
                        </div>
                        <span class="text-xs">Bid started on Apr 12, 2024 2:12 AM</span>
                        <span class="text-base-content py-2">Description</span>
                    </div>
                    <div class="border-t border-slate-700 pt-3">
                        <button class="btn btn-error w-full btn-sm">End</button>
                    </div>
                </div>
                <div class="w-full overflow-y-auto">
                    <div class="flex gap-2 px-3">
                        <div class="w-full rounded p-3 bg-slate-800">
                            <div class="flex gap-2 w-full justify-between">
                                <div>
                                    <span class="badge  badge-warning font-bold text-xs">
                                        New
                                    </span>
                                    <span class="font-bold place-self-center text-xs">
                                        Submitted by <a href="#" class="link link-primary">John Doe</a>
                                    </span>
                                </div>
                                <span class="text-xs place-self-center order-end ">Date Submitted: Apr 19, 2024 4:14 AM</span>
                            ...
                            <div class="flex">
                                <div class="w-11/12">
                                    ...
                                    <p class="text-base-content text-sm py-2">Description</p>
                                ...
                                <div class="w-3/12 flex flex-col gap-2">
                                    <button class="btn btn-sm btn-warning w-full">Choose</button>
                                    <button class="btn btn-sm btn-outline btn-ghost w-full">Edit</button>
                                    <button class="btn btn-sm btn-error w-full">Cancel</button>
                                </div>
                            </div>
                            <div class="divider m-0"></div>
                            <p class="font-bold text-success">Price</p>
                        </div>
                    </div>
                </div>
            </main>
