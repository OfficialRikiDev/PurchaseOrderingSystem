...
<head>
    ...
    <script defer type="text/javascript" src="/js/store.js"></script>
            ...
            <div class="flex bg-base-200 px-4 py-2 justify-between w-full">
                ...
                if ($_SESSION['role'] == 2) {
                    echo '<div class="order-last">
                        <a class="text-xs hover:underline p-1 rounded-full" href="/store/my">
                            My Shop
                        </a>
                    </div>';
                }
            ...
            <div class="flex w-full h-full overflow-hidden">
                ...
                <div class="w-2/12 bg-base-100">
                    <main class="flex flex-wrap gap-x-2 gap-y-3 w-full p-4 mx-auto">
                        <button id="addProductBtn" class="btn btn-sm btn-primary w-full">Add Product</button>
                    </main>
                </div>
            </div>
        </div>
