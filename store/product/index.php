                                ...
                                <div class="flex flex-col md:flex-row -mx-4">
                                    ...
                                    <div class="md:flex-1 px-4">
                                        ...
                                        <div class="flex items-center space-x-4 my-4">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-green-500 text-xl font-semibold">Stock Available: <?php echo $prod['stocks'];?></p>
                                        ...
                                        <div class="flex py-4 space-x-4">
                                            ...
                                            if ($_SESSION['role'] == 3) {
                                                echo ' <div class="relative">
                                                        ...
                                                        <select id="item_amount" class="cursor-pointer appearance-none rounded-xl border border-gray-200 pl-4 pr-8 h-14 flex items-end pb-1">
                                                ...
                                                echo ' <button type="button" onclick="addToCart(this, ' . $_GET['prod_id'] . ')" class="h-14 px-6 py-2 font-semibold rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white">
                                                            Add to Cart
                                                        </button>';
                                            }
                                            ?>
