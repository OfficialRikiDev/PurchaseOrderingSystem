...
if (!isset($_SESSION['username'])) {
    ...
    }elseif($_SESSION['ispending'] == 0 && $_SESSION['activated'] == 1){
...
if(isset($_GET['activate'])){
    if($data->activateAccount($_SESSION['id'])){
            ...
            <div class="flex flex-row bg-gray-800 shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full max-w-4xl ">
                ...
                <div class="w-full h-full m-4 place-content-center">
                    <div class="w-full text-center">
                        <h1 class="text-3xl font-bold">Hi <?php echo $_SESSION['username']?>! <br>You're finally in there!</h1>
                        <p class="py-2">Application approved. Activate your account now.</p>
                        <a href="?activate=" class="btn btn-sm mt-8 btn-error text-white">Activate</a>
                    </div>
                </div>
            </div>
        </div>
